...
from mailing.models import Mailing, Customer, Message, MailingAttempt
...
def get(request, *args, **kwargs):
    ...
    unique_clients_count = Customer.objects.distinct().count()
    context = {
...
class CustomerListView(LoginRequiredMixin, ListView):
    model = Customer
    template_name = "mailing/customer_list.html"
...
class CustomerDetailView(DetailView):
    model = Customer
    template_name = "mailing/customer_detail.html"


class CustomerCreateView(CreateView):
    model = Customer
    form_class = CustomerForm
    template_name = "mailing/customer_form.html"
...
class CustomerDeleteView(DeleteView):
    model = Customer
    template_name = "mailing/customer_confirm_delete.html"
    success_url = reverse_lazy("mailing:customer_list")
